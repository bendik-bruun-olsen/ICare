...
export default function PatientDetailsPage(): JSX.Element {
  ...
  const handleDeletePatient = (currentPatientId: string): void => {
    try {
      if (!currentPatientId) return;
      deletePatient(currentPatientId, addNotification);
    ...
    <>
      ...
      <div className={styles.fullWrapper} ref={fullInfoContainerRef}>
        ...
        <div className={styles.buttonContainer}>
          <Button onClick={handleDeletePatient(currentPatientId)}>
            Delete Patient
          </Button>
