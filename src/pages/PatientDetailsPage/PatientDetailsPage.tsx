...
export default function PatientDetailsPage(): JSX.Element {
	...
	const handleDelete = async (currentPatientId: string): Promise<void> => {
		try {
			await Promise.all([
				deletePatientfromUserDB(currentPatientId, addNotification),
				deletePatientfromPatientDB(currentPatientId, addNotification),
			]);
		...
		<>
			...
			<div className={styles.fullWrapper} ref={fullInfoContainerRef}>
				...
				<div className={styles.buttonContainer}>
					<Button onClick={() => handleDelete(currentPatientId as string)}>
						Delete patient
					</Button>
